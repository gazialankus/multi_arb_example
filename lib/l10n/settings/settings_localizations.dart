...
import 'settings_localizations_ru.dart';
...
abstract class SettingsLocalizations {
  ...
  /// No description provided for @settings_screen_tab_name_settings.
  ///
  /// In en, this message translates to:
  /// **'Settings'**
  String get settings_screen_tab_name_settings;
  ...
  /// No description provided for @settings_screen_language_name_en.
  ///
  /// In en, this message translates to:
  /// **'English'**
  String get settings_screen_language_name_en;

  /// No description provided for @settings_screen_language_name_ru.
  ///
  /// In en, this message translates to:
  /// **'Русский'**
  String get settings_screen_language_name_ru;
}
...
SettingsLocalizations lookupSettingsLocalizations(Locale locale) {
  ...
  switch (locale.languageCode) {
    ...
    case 'ru': return SettingsLocalizationsRu();
  }
