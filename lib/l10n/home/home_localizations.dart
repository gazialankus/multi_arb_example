...
abstract class HomeLocalizations {
  ...
  /// No description provided for @home_screen_label_content.
  ///
  /// In en, this message translates to:
  /// **'Hello World!'**
  String get home_screen_label_content;

  /// No description provided for @home_screen_tab_name_home.
  ///
  /// In en, this message translates to:
  /// **'Home'**
  String get home_screen_tab_name_home;
}
